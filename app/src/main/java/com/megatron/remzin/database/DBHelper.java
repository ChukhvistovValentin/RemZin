...
public class DBHelper extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "remzin_database";
    ...
    private static final String TASKS_TABLE_CREATE_SCRIPT = "CREATE TABLE tasks_table (_id INTEGER PRIMARY KEY AUTOINCREMENT, " +
            "task_title TEXT NOT NULL, task_text TEXT NOT NULL, task_date LONG, task_priority INTEGER, task_status INTEGER, "+
            "task_time_stamp LONG, task_img TEXT);";
    ...
    public static final String TASK_TEXT_COLUMN = "task_text";
    public static final String TASK_IMG_COLUMN = "task_img";
    ...
    public void saveTask(ModelTask task) {
        ...
        newValues.put(TASK_TEXT_COLUMN, task.getText());
        ...
        newValues.put(TASK_IMG_COLUMN, task.getImg());
